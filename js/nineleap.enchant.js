...
(function() {
     ...
     * @type {Object}
     */
    enchant.nineleap = { assets: ['../lastweek/img/start.png', '../lastweek/img/end.png'] };
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets['../lastweek/img/start.png'];
                ...
                this.endScene.image = this.assets['../lastweek/img/end.png'];
